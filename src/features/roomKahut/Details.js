          ...
          <Box key={index} sx={{ boxShadow: 5, backgroundColor: 'white', }}>
            ...
            >
              <ListItemAvatar sx={{ p: 0, m: 0, width: 170, height: '100%', }}>
                <Avatar sx={{ width: '100%', height: '100%', borderRadius: 0.5 }} alt="Image alt" src={eachQuestion.img} variant="square" />
              </ListItemAvatar>
              <Box sx={{ py: 1, px: 1, width: '100%', height: '100%' }}>
                ...
                >
                  <Stack spacing={1} direction='row' sx={{ width: '50%' }}>
                    <Chip label={eachQuestion.time + " seconds"} variant='outlined' size="small" color="info" sx={{ fontWeight: 'bold', fontSize: 14 }} />
                    <Chip label={optionsPoints[eachQuestion.points]} variant='outlined' size="small" color="secondary" sx={{ fontWeight: 'bold', fontSize: 14 }} />
                  </Stack>
                  <Stack
                    textAlign='center'
        ...
        <>
          <Grid item xs={4} sx={{ boxShadow: '3px 0 3px grey' }}>
            <Stack spacing={2} sx={{ px: 2, pb: 2 }}>
              ...
              <Stack spacing={1} direction='row' sx={{ mt: 3, width: '100%' }}>
                <Chip label={curRoom.questions.length + " questions"} variant='outlined' size="medium" color="info" sx={{ px: 1, fontWeight: 'bold', fontSize: 17 }} />
                <Chip label={curRoom.plays + " plays"} variant='outlined' size="medium" color="secondary" sx={{ px: 1, fontWeight: 'bold', fontSize: 17 }} />
                <Box sx={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              <Stack spacing={1} direction='row'>
                <PersonOutlineIcon />
                <Typography>A private kahut</Typography>
              </Stack>
              <Divider />
          ...
          <Grid item xs={8}>
            ...
            >
              ...
              >
                <Typography sx={{ opacity: 0.8, color: '#333333', fontSize: 22, fontWeight: 'bold' }}>{"Questions (" + curRoom.questions.length + ")"}</Typography>
              </Box>
              <Box
                sx={{
                  width: '30%',
            ...
            <NestedList listQuestion={curRoom.questions} isShowAnswer={isShowAnswer} />
          </Grid>
        </>
      }
    </Grid >
